...
```{r data/model}
#read data
spatialdata<-read_csv("~/Downloads/celia-exp/mturk_spatial.csv")
...
tab_model(mod3, mod4,
          pred.labels = c("Intercept", "Category (indeterminate)", "Category (abstract)", "Liking Rating (1-7)", "Hours spent with art per week (1-4)","Art Experience (enthusiast)", "Abstraction Rating"),dv.labels = c("P (in 1 y)", "P (in 1 y)"), show.re.var =FALSE, show.est=TRUE, show.reflvl=TRUE, transform = NULL, p.style = "both", string.est = "b",string.ci = "95% CI", string.p = "P value", show.icc = FALSE, file = "~/Desktop/PNAS_tables.docx")
